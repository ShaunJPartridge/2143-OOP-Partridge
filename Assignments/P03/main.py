...
class Person(pygame.sprite.Sprite):
    ...
    def collide(self, other,social_distance=20):#put in simulation class
...
class Population(Person):
    ...
    def countSusceptible(self):
        ...
        return self.number_susceptible
...
if __name__=='__main__':
    ...
    # a list to hold population of people sprites
    population = []
    count = 0
    for i in range(12):
        ...
        if i == 1:
            population.append("susceptible")
        if i == 2:
            population.append("infected")
        if i == 3:
            population.append("recovered")
        print(population)
    ...
    print("Number of people infected:", count)